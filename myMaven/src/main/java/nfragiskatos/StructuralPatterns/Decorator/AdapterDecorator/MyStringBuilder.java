...
public class MyStringBuilder {
    ...
    /**
     * Problem here is we want a fluid interface, but all of these delegates return a [StringBuilder] and not a
     * [MyStringBuilder] as they should.
     *
     * To preserve the fluid interface we'd have to modify all of the methods to return this instead, and change the
     * method signatures. A lot of manual labor... or you have to get a regular expression, or something blah blah blah
     *
     */
    // Decorator
